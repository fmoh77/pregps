...
@section('content')
    ...
    <div class="section mt-2" id="presence-section">
        ...
        <div id="rekappresensi">
            <h4>Rekap Presensi Bulan {{ $bulanini }} Tahun {{ $tahunini }}</h4>
            <div class="row">
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding:12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="accessibility-outline" style="font-siza:1.6rem;"
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding:12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="newspaper-outline" style="font-siza:1.6rem;" class="text-success"></ion-icon>
                            <br>
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding:12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="medkit-outline" style="font-siza:1.6rem;" class="text-warning"></ion-icon>
                            <br>
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding:12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="document-text-outline" style="font-siza:1.6rem;"
...
<li>
    @endforeach
                    ...
                    @foreach ($historibulanini as $d)
                        @if ($d->status == 'h')
                            <div class="card mb-1" style="border: 1px solid rgb(0, 0, 0)">
                                <div class="card-body">
                                    <div class="historicontent">
                                        ...
                                        <div class="datapresensi">
                                            ...
                                            <span>
                                                {!! $d->jam_in != null ? date('H:i', strtotime($d->jam_in)) : '<span class="danger">Belum Absen</span>' !!}
                                            </span>
                                            <span>
                                                {!! $d->jam_out != null
                        ...
                        @elseif($d->status == 'i')
                            <div class="card mb-1" style="border: 1px solid rgb(0, 0, 0)">
                                <div class="card-body">
                                    <div class="historicontent">
                                        <div class="iconpresensi">
                                            <ion-icon name="document-text-outline" style="font-size: 48px;"
                                                class="text-primary"></ion-icon>
                                        </div>
                                        <div class="datapresensi">
                            ...
                            <li>
                                <div class="item">
                                    ...
                                    <div class="in">
                                        ...
                                        <span class="badge {{ $jam_in < $jam_masuk ? 'bg-success' : 'bg-danger' }} ">
                                            {{ $d->jam_in }}
                                        </span>
                                    </div>
                                </div>
